(ns telecomtech.actor
  "TelecomEngineeringTechniciansActor — the ISCO-08 3522 community telecomtech actor as a
  `langgraph.graph/state-graph` (ADR-2607011000 / CLAUDE.md Actors
  section). One graph run = one telecomtech operation request
...
(defn build-graph
  ...
  `telecomtech.store/Store`. `advisor` implements
  `telecomtech.advisor/Advisor` (defaults to `mock-advisor`).
